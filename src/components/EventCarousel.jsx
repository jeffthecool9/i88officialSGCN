  ...
  return (
    <div className="glass-card flex-none w-52 h-[210px] rounded-2xl overflow-hidden relative">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4">
        <p className="font-body text-[10px] font-semibold tracking-[0.12em] uppercase text-brand mb-1">
          {tag}
        </p>
        <h3
        ...
        <p className="font-body text-ice/75 text-xs leading-snug">{date}</p>
      </div>
    </div>
  )
}
